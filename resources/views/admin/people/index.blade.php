                ...
                <div class="col-lg-12">               
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Agregar Persona</h3>
                    </div>
                    <div class="card-body">
                      ...
                      {{ csrf_field() }}
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="description" placeholder="Descripción del tipo de persona" class="form-control" value="{{ old('description') }}">
                        </div>                                               
                        <div class="form-group">       
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="/persona/{{ $person->id }}" class="btn btn-sm btn-primary" title="Editar">
                                  <i class="fa fa-pencil"></i>
                                </a>
                                <a href="/persona/{{ $person->id }}/eliminar" class="btn btn-sm btn-danger" title="Eliminar">
